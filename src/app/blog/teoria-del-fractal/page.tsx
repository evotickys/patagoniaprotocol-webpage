...
export default function PostPage(){
  const post = findPost('teoria-del-fractal');
  if(!post) return <div className="p-8">Post no encontrado</div>
  return (
    <main className="min-h-screen">
      <div className="post-hero py-28 text-white" style={{backgroundImage:`linear-gradient(rgba(0,0,0,0.35),rgba(0,0,0,0.35)), url('/imagenes-blog/teoria-del-fractal/hero.jpg'), url('${post.image}')`, backgroundSize:'cover', backgroundPosition:'center'}}>
